...
public class Projectile : MonoBehaviour {
    ...
    public Transform [] energyShieldImpactPrefabs;
	...
	private void OnCollisionEnter (Collision collision)
	{
        ...
        //If bullet collides with "EnergyShield" tag
        if (collision.transform.tag == "EnergyShield")
        {
            //Instantiate random impact prefab from array
            Instantiate(energyShieldImpactPrefabs[Random.Range
                (0, energyShieldImpactPrefabs.Length)], transform.position,
                Quaternion.LookRotation(collision.contacts[0].normal));
            //Destroy bullet object
            Destroy(gameObject);
        }
